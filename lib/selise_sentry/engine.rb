...
module SeliseSentry
  class Engine < ::Rails::Engine
    isolate_namespace SeliseSentry
    ...
    initializer "selise_sentry.init_sentry", after: :load_config_initializers do
      SeliseSentry::SentrySetup.init! if SeliseSentry.configuration.initialize_sentry
    end
