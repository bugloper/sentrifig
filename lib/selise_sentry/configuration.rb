...
module SeliseSentry
  # Public configuration for selise-sentry.
  #
  ...
  class Configuration
    ...
    USERNAME_ENV = "SELISE_SENTRY_USERNAME"
    PASSWORD_ENV = "SELISE_SENTRY_PASSWORD"

    # HTTP Basic Auth credentials for the mounted UI. Default to the
    # SELISE_SENTRY_USERNAME / SELISE_SENTRY_PASSWORD environment variables so
    ...
    # What SeliseSentry.enabled? returns when the database holds no record for
    ...
    # Logger used for operational messages ("[selise-sentry] Sentry disabled").
