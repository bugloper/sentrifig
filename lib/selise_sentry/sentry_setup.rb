...
module SeliseSentry
  ...
  module SentrySetup
    ...
    class << self
      ...
      def init!(configuration = SeliseSentry.configuration)
        if ::Sentry.initialized?
          SeliseSentry.logger.warn(
            "[selise-sentry] Sentry was already initialised by the application; skipping the default Sentry.init. " \
