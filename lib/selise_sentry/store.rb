...
module SeliseSentry
  # Control-plane persistence. Talks to the selise_sentry_settings table through
  # the SeliseSentry::Setting ActiveRecord model and knows nothing about caching.
  #
