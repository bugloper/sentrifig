...
require_relative "lib/selise_sentry/version"

Gem::Specification.new do |spec|
  spec.name        = "selise-sentry"
  spec.version     = SeliseSentry::VERSION
  spec.authors     = ["SELISE"]
  spec.summary     = "Runtime on/off switch for Sentry in Rails, with a mountable Basic-Auth protected UI."
  spec.description = <<~DESC
    selise-sentry lets operators enable or disable Sentry error reporting for a Rails
  ...
  DESC
  spec.homepage    = "https://github.com/selise/selise-sentry"
  spec.license     = "MIT"
